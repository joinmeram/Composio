...
Each entry: (app_name, category, hint_url)
"""
...
APPS = [
    ...
    ("systeme.io", "Marketing, Ads, Email and Social", "systeme.io"),
    ...
    ("Waterfall.io", "Data, SEO and Scraping", "waterfall.io"),
    ...
    ("NotebookLM", "AI, Research and Media-native", "cloud.google.com/gemini"),
    ("Otter AI", "AI, Research and Media-native", "help.otter.ai"),
    ("Fathom", "AI, Research and Media-native", "fathom.video"),
    ("Consensus", "AI, Research and Media-native", "consensus.app"),
    ("Reducto", "AI, Research and Media-native", "reducto.ai"),
    ("Devin", "AI, Research and Media-native", "docs.devin.ai"),
    ("higgsfield", "AI, Research and Media-native", "higgsfield.ai/cli"),
    ...
    ("Grain", "AI, Research and Media-native", "grain.com"),
]
